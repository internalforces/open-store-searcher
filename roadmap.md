...
- [ ] Approve the language, framework, package manager, and repository structure through an ADR.
- [ ] Set up the Apache-2.0 repository and development, testing, and static-build foundation.
