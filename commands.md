...
or failure, writes only schema metadata to a new candidate path, and never publishes data. Review a
candidate before copying it into the committed archive contract.
