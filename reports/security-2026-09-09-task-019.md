...
| Unsafe external navigation | No finding | [encoding and fixed HTTPS map hosts](https://github.com/internalforces/open-store-searcher/blob/b61483891b4db918e7a5b25eebd326968ba011da/src/shared/map-search-links.ts#L14-L24), [protected map tabs](https://github.com/internalforces/open-store-searcher/blob/b61483891b4db918e7a5b25eebd326968ba011da/src/app/map-links.tsx#L19-L30), [source HTTPS/credential filter and referrer policy](https://github.com/internalforces/open-store-searcher/blob/b61483891b4db918e7a5b25eebd326968ba011da/src/app/evidence-context.tsx#L42-L49); browser tests at lines 611 and 785 | Map URLs encode candidate fields, use fixed HTTPS hosts, and disclose transfer before activation. New tabs have noopener/noreferrer; source links reject non-HTTPS and credentials. Browser tests intercept destinations locally and verify null opener/no Referer. No map provider page was inspected. | No |
...
TASK-019's current-code review is complete, but the overall task retains an unchecked Actions
criterion in its [acceptance record](../tasks/completed.md#task-019-acceptance-criteria-and-evidence).
No prior approval of an Actions exemption is evidenced. TASK-010 owns workflow trigger/input/permission,
