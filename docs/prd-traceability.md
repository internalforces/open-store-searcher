...
| FR-13 | Preserve previous data after refresh failure | TASK-005, 008 through TASK-010, 015 | TASK-005 fail-closed staged collector, 195-entry schema contract, changed/unchanged outcomes, rejected-body cancellation, early retrieval-evidence validation, and rejection tests establish the non-publication boundary; last-known-good replacement and workflow failure injection remain pending | In progress |
