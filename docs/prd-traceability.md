...
| FR-09 | Always-accessible source and disclaimer | TASK-004, 014, 020 | ADR-009 and `reports/research-2026-08-28-source-data-contract.md` approve and document source provenance and as-of requirements; UI and documentation review pending | In progress |
