...
- Version: v0.1.0-dev
- Phase: M1 — TASK-004 complete; TASK-005 collector design active
- Next milestone: M1 — approve and implement the bounded TASK-005 contract probe
- Overall health: 🟡 Caution — the zero-key Seoul ZIP candidate has complete permission coverage,
  but cross-entry data-cut consistency and the automation contract remain unverified
