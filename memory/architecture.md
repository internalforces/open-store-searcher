...
| Candidate source contract | Official Seoul all-category ZIP, gated by a fail-safe TASK-005 contract probe | 2026-08-28 |
...
- ADR-009 accepts the official zero-key Seoul all-category ZIP as the candidate default source.
  TASK-005 must probe its automation stability, complete category manifest, schema, permissions,
  archive integrity, and as-of inputs before production collection or publication is allowed.
